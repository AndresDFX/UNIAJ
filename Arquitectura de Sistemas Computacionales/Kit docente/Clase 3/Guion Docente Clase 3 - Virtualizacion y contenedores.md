...
### 40–55 · Demo en vivo
Herramienta del día: **Play with Docker (PWD) · alterna si no carga: Killercoda**.
**Demo que usted debe poder repetir:** Construir y correr el stub en Play with Docker

1. Abra labs.play-with-docker.com y cree una instancia (advierta en voz alta: la sesion dura 4 horas y se autodestruye).
...
1. Que pasa con su trabajo cuando expira la sesion de Play with Docker?
