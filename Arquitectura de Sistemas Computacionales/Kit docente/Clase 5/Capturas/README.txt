Capturas de la Clase 5 — Arquitectura de Sistemas Computacionales
==============================================================
...
Pendiente: demo-clase05.png — la herramienta del dia en uso
  1. Abrir —.
  2. Reproducir el ejercicio del bloque sobre el dominio CloudLite de ejemplo.
  3. Capturar solo la ventana util, no el escritorio completo.
  4. Recortar a ~1200 px de ancho.
  5. Guardar aqui como demo-clase05.png.
...
Despues de agregar una imagen, regenerar el guion:
  SOLO_CLASES=5 python config/slides/build_uniajc_arq_clases_batch.py
