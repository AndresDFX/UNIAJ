...
### De donde viene la clase y que se abre hoy - diapositiva 13
...
### Monolito: lo que la palabra realmente significa - diapositiva 4
...
### Las tres reglas del nivel Container y la trazabilidad con el Context - diapositiva 5
...
### C4Container en Mermaid: la sintaxis que la plataforma renderiza - diapositiva 10
...
### Primer ejemplo: los tres contenedores de CloudLite Turnos - diapositiva 8
...
### Los contratos: cuatro datos por fila y un 409 obligatorio - diapositiva 6
...
### Lo que se paga al distribuir: la red no es una llamada de funcion - diapositiva 7
...
### Timeout, reintento, idempotencia y circuit breaker - diapositiva 7
...
### Los datos: donde se rompen los proyectos academicos - diapositiva 9
...
### El tercer entregable: los tres riesgos, y por que son esos tres - diapositiva 7
...
10. C4Container en Mermaid: el molde que ExamLab renderiza
11. Herramientas de hoy
12. Del boceto a ExamLab (diagrama)
13. PI CloudLite — entregable de hoy
14. Manos a la obra (paso a paso)
15. Para continuar (PI)
16. Clase 4 · PI en movimiento

## Plan de clase minuto a minuto (120 min)

### 0–10 · Encuadre PI · [Slide 2][Slide 3][Slide 13]
...
Narra los clics en voz alta. Si falla la red, proyecta la [Slide 10], que ya trae el resultado de la demo, y recórrela rótulo por rótulo.
