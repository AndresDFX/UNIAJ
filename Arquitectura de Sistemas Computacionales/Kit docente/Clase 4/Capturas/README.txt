...
Pendiente: demo-clase04.png — la herramienta del dia en uso
  1. Abrir Navegador · editor de diagramas del curso (Mermaid) · boceto libre opcional.
  2. Repetir la demo: Convertir el Context de la Clase 1 en Containers, y dejarlo renderizado en la plataforma.
