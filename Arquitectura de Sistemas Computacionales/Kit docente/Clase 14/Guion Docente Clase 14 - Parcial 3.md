# Guion docente — Clase 14: Parcial 3

## Información de la clase
- Asignatura: Arquitectura de Sistemas Computacionales (FI303380)
- Duración del bloque: **120 min** · **virtual síncrona por Google Meet**
- Tipo: **Solo evaluación (Parcial 3)** — sin tema nuevo y sin taller dirigido
- Proyecto Integrador: CloudLite App (hoy **no** se avanza)
- Instrumento: `Parciales/Parcial 3 - Rendimiento escalabilidad y cierre de proyecto.docx` · la solución es el mismo nombre con «- SOLUCION» y **no se publica en `Clases/`**
- Fecha: 09/11/2026 · tiempo de resolución previsto por el instrumento: **90–100 minutos**
- Peso: **15% del Corte 3 (40%)** · 100 puntos · nota = puntos / 20 sobre 5.0

## Objetivo del bloque
Aplicar el **Parcial 3 — Rendimiento, escalabilidad y cierre de proyecto**, que evalúa **solo** estas clases de material:

   - Clase 11 · 26/10 · Avance del proyecto final (sesión doble)
   - Clase 12 · 26/10 · Pruebas de rendimiento · Preparación de presentación final (sesión doble)
   - Clase 13 · 02/11 · Escalabilidad automática (sesión autónoma)
...
1. Abre `Parciales/Parcial 3 - Rendimiento escalabilidad y cierre de proyecto.docx` y **decide el canal de entrega**, porque el enunciado dice
...
- No se responde, en este parcial: «¿escalar horizontal es lo mismo que subirle la RAM?» · «¿la prueba de carga mide latencia o throughput?» · «¿esta opción es la correcta?».
...
Di: «Gracias. En la Clase 15 es la **sustentación del Proyecto Integrador**: lo que presentan es el CloudLite que ya construyeron, no algo nuevo.» No adelantes respuestas ni comentes el parcial: todavía hay
...
- **Responder la duda de contenido porque parece inofensiva.** «¿escalar horizontal es lo mismo que subirle la RAM?» es
...
**¿Entra lo de la Clase 13?** Sí, es lo más reciente que entra y se evalúa igual, aunque se haya trabajado sin sesión en vivo: es la que más se olvida al estudiar. La portada del enunciado lista las clases evaluadas con su fecha; fuera de esa
lista no hay nada.
...
**¿Cuánto tiempo tengo?** El instrumento prevé **90–100 minutos** y el bloque son 120: hay
...
- La preparación del pitch del PI fue la **Clase 12**; hoy no se prepara nada del proyecto.
