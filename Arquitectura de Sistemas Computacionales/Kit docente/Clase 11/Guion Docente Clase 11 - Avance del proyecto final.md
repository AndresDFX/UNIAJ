...
### La teoria propia del dia: que es una revision de arquitectura - diapositiva 4
...
### El insumo: las seis piezas del paquete CloudLite v1 - diapositiva 5
...
### Las cinco preguntas de coherencia, en orden - diapositiva 5
...
### Scope creep y arquitectura de papel: las dos patologias con nombre propio - diapositiva 6
...
### Retroalimentacion accionable: observacion, evidencia, impacto y accion con fecha - diapositiva 7
...
### El semaforo: el umbral que decide si el proyecto va a tiempo - diapositiva 7
