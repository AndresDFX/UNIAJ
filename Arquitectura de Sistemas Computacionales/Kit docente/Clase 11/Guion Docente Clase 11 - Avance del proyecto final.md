...
### La teoria propia del dia: que es una revision de arquitectura - diapositiva 9
...
### El insumo: las seis piezas del paquete CloudLite v1 - diapositiva 4
...
### Las cinco preguntas de coherencia, en orden - diapositiva 4
...
### Scope creep y arquitectura de papel: las dos patologias con nombre propio - diapositiva 5
...
### Retroalimentacion accionable: observacion, evidencia, impacto y accion con fecha - diapositiva 6
...
### El semaforo: el umbral que decide si el proyecto va a tiempo - diapositiva 6
...
**Cierra la demo dentro de ExamLab** [Slide 8] — es el paso que el estudiante no adivina: pasa el boceto a codigo Mermaid con ayuda de una IA, pegalo en la pregunta de diagrama y muestralo renderizado.
