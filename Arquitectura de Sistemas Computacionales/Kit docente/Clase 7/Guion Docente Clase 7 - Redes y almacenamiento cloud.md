...
### El tercer angulo: que responde el diagrama de despliegue - diapositiva 11
...
### IP, puerto y protocolo: las tres etiquetas de cada flecha - diapositiva 4
...
### Subred publica y privada: lo definen las rutas, no el nombre - diapositiva 4
...
### DNS y balanceador de carga - diapositiva 4
...
### Los tres nombres de almacenamiento que califica la pregunta 5 - diapositiva 5
...
### El caso de la foto de perfil, y cuando la respuesta correcta es «no necesito objeto» - diapositiva 5
...
### Trazabilidad: la tabla de correspondencia de la pregunta 6 - diapositiva 6
...
### Recorrer una peticion de CloudLite de punta a punta - diapositiva 7
...
### El molde de Mermaid, linea por linea - diapositiva 8
...
8. El Despliegue en Mermaid: el molde que ExamLab renderiza
