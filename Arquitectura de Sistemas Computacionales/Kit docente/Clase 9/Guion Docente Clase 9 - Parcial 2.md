# Guion docente — Clase 9: Parcial 2

## Información de la clase
- Asignatura: Arquitectura de Sistemas Computacionales (FI303380)
- Duración del bloque: **120 min** · **virtual síncrona por Google Meet**
- Tipo: **Solo evaluación (Parcial 2)** — sin tema nuevo y sin taller dirigido
- Proyecto Integrador: CloudLite App (hoy **no** se avanza)
- Instrumento: `Parciales/Parcial 2 - Seguridad redes monitoreo y CI-CD.docx` · la solución es el mismo nombre con «- SOLUCION» y **no se publica en `Clases/`**
- Fecha: 19/10/2026 · tiempo de resolución previsto por el instrumento: **90–100 minutos**
- Peso: **10% del Corte 2 (30%)** · 100 puntos · nota = puntos / 20 sobre 5.0

## Objetivo del bloque
Aplicar el **Parcial 2 — Seguridad, redes, monitoreo, CI/CD y costos**, que evalúa **solo** estas clases de material:

   - Clase 6 · 28/09 · Seguridad en la nube
   - Clase 7 · 05/10 · Redes y almacenamiento cloud (sesión doble)
   - Clase 8 · 05/10 · Monitoreo y optimización · Integración continua y despliegue (CI/CD) (sesión doble)
   - Clase 10 · 12/10 · Costos y sostenibilidad cloud (sesión autónoma)
...
1. Abre `Parciales/Parcial 2 - Seguridad redes monitoreo y CI-CD.docx` y **decide el canal de entrega**, porque el enunciado dice
...
- No se responde, en este parcial: «¿de la seguridad se encarga el proveedor o el cliente?» · «¿un bucket es almacenamiento de bloques o de objetos?» · «¿esta opción es la correcta?».
...
Di: «Gracias. El PI CloudLite continúa en la siguiente clase; hoy no hay tarea nueva.» No adelantes respuestas ni comentes el parcial: todavía hay
...
- **Responder la duda de contenido porque parece inofensiva.** «¿de la seguridad se encarga el proveedor o el cliente?» es
...
**¿Entra lo de la Clase 10?** Sí, es lo más reciente que entra y se evalúa igual, aunque se haya trabajado sin sesión en vivo: es la que más se olvida al estudiar. La portada del enunciado lista las clases evaluadas con su fecha; fuera de esa
lista no hay nada.
...
- En este corte no hay preparación de pitch: el PI se retoma en la siguiente clase regular.
