# Clase 9 — Solo Parcial 2

- Bloque 120 min · **virtual síncrona por Google Meet** · **sin taller PI**.
- Enunciado: `Parciales/Parcial 2 - Seguridad redes monitoreo y CI-CD.docx` · la solución es el mismo nombre con
  `- SOLUCION` y **no se publica en `Clases/`**.
- Evalúa **solo** las Clases 6, 7, 8 y 10 · 100 puntos · nota = puntos / 20 ·
  peso **10% del Corte 2 (30%)**.
...
- En este corte no hubo preparación de pitch; hoy no se avanza en el proyecto y el PI se retoma en la siguiente clase regular.

El detalle minuto a minuto, los errores típicos y las preguntas frecuentes están en
`Guion Docente Clase 9 - Parcial 2.md`.
