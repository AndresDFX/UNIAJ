Capturas de la Clase 9 — Arquitectura de Sistemas Computacionales
==============================================================
...
Pendiente: demo-clase09.png — la herramienta del dia en uso
  1. Abrir —.
  ...
  5. Guardar aqui como demo-clase09.png.
...
Despues de agregar una imagen, regenerar el guion:
  SOLO_CLASES=9 python config/slides/build_uniajc_arq_clases_batch.py
