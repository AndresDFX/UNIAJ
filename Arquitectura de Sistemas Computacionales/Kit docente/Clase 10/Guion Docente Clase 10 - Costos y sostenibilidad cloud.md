...
### Clase autonoma: de gasto de capital a gasto operativo medido - diapositiva 7
...
### Primer ejemplo: la tabla del entregable, componente por componente - diapositiva 4
...
### Segundo ejemplo: por que el driver importa mas que el nivel - diapositiva 4
...
### Right-sizing: tres acciones ancladas en observacion - diapositiva 4
...
### Sostenibilidad tecnica antes que ambiental - diapositiva 5
...
### Preguntas frecuentes y cierre conceptual (de la diapositiva 4 a la diapositiva 5)
...
7. PI CloudLite — entregable de hoy
8. Manos a la obra (paso a paso)
9. Para continuar (PI)
