...
### Clase autonoma: de gasto de capital a gasto operativo medido - diapositiva 4
...
### CloudLite no tiene factura real, y por que igual se estima - diapositiva 5
...
### Ordenes de magnitud que el docente debe poder citar - diapositiva 5
...
### Primer ejemplo: la tabla del entregable, componente por componente - diapositiva 5
...
### Segundo ejemplo: por que el driver importa mas que el nivel - diapositiva 5
...
### Right-sizing: tres acciones ancladas en observacion - diapositiva 5
...
### Sostenibilidad tecnica antes que ambiental - diapositiva 6
...
### Preguntas frecuentes y cierre conceptual (de la diapositiva 5 a la diapositiva 6)
