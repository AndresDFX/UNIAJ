...
### Seguridad como propiedad del diseno: la triada CIA - diapositiva 12
...
### Modelar amenazas: las cuatro preguntas y el vocabulario - diapositiva 4
...
### STRIDE: seis categorias, cada una niega una propiedad - diapositiva 4
...
### Los controles gratuitos, en tres familias - diapositiva 5
...
### Menor privilegio: la resta que hay que poder nombrar - diapositiva 6
...
### Gestion de secretos: el error mas repetido y el mas facil de verificar - diapositiva 7
...
### La politica en cuatro respuestas: quien rota, cada cuanto y que se hace ante una filtracion - diapositiva 7
...
### Primer ejemplo: autenticacion con token en CloudLite - diapositiva 8
...
### Segundo ejemplo: PII y las tres amenazas de identidad - diapositiva 9
...
### El entregable: tres columnas, y la tercera es una caja o una flecha - diapositiva 9
...
10. El secreto en la imagen: por qué borrarlo no sirve
11. Herramientas de hoy
12. PI CloudLite — entregable de hoy
13. Manos a la obra (paso a paso)
14. Para continuar (PI)
15. Clase 6 · PI en movimiento

## Plan de clase minuto a minuto (120 min)

### 0–10 · Encuadre PI · [Slide 2][Slide 3][Slide 12]
