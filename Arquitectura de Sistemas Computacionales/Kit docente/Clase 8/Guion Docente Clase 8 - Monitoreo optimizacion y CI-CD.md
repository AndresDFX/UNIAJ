...
### Integracion continua: el problema que resuelve, en definicion operativa - diapositiva 9
...
### Entrega continua y despliegue continuo: la sigla CD es ambigua - diapositiva 4
...
### GitHub Actions en cinco palabras - diapositiva 5
...
### Los tres bloques que la pregunta 7 califica, y el orden de los pasos - diapositiva 5
...
### Monitorear y observar: la segunda mitad cambia de lado - diapositiva 6
...
### Las cuatro senales de oro, con definicion operativa - diapositiva 6
...
### La tabla de senales de la pregunta 10, con sus tres columnas exactas - diapositiva 6
...
### El pipeline del stub de CloudLite, paso por paso - diapositiva 7
...
### La condicion de fallo: la pregunta que separa un CI de una decoracion verde - diapositiva 7
...
### Donde se ejecuta de verdad la politica de secretos de la Clase 6 - diapositiva 7
...
### Preguntas frecuentes del grupo - diapositiva 6
...
7. .github/workflows/ci.yml — CI real, no un echo
8. Herramientas de hoy
9. PI CloudLite — entregable de hoy
10. Manos a la obra (paso a paso)
11. Para continuar (PI)
12. Clase 8 · PI en movimiento

## Plan de clase minuto a minuto (120 min)

### 0–10 · Encuadre PI · [Slide 2][Slide 3][Slide 9]
