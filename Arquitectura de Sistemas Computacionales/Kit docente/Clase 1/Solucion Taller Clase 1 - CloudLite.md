...
- Taller: `Clases/Clase 1 - Introduccion a arquitecturas cloud/Taller Clase 1 - CloudLite.docx`
...
1. Equipo 2-3. Dominio: AgendaU (tutorías estudiante-docente).
2. Problema: estudiantes pierden turnos por doble agenda y recordatorios débiles.
3. Actores: Estudiante, Tutor, CloudLite App; SaaS: correo/calendario.
4. Capacidades: reservar, cancelar, recordar, ver disponibilidad.
