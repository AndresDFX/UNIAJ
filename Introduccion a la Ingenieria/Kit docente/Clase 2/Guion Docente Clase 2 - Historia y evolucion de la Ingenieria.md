...
10. La pregunta de entrada y para qué sirve incomodar con una fecha
11. Por qué la disciplina nace de un fracaso y no de un invento (1/2)
12. Por qué la disciplina nace de un fracaso y no de un invento (2/2)
13. Los seis hitos: qué decir de cada uno en dos minutos (1/3)
14. Los seis hitos: qué decir de cada uno en dos minutos (2/3)
