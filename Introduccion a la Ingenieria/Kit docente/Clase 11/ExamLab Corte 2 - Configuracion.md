# Evaluación de corte de la Clase 11 en ExamLab - configuracion

- **Curso:** Introducción a la Ingeniería (FI300101)
- **Evaluación de corte:** Evaluacion del Corte 2 - Ciclo de vida, requisitos, decision, antecedentes y prototipo
...
Un requisito quedó mal escrito en la fase de requisitos y nadie lo notó. ¿En qué momento su corrección cuesta órdenes de magnitud más, y por qué?
...
## Pregunta 3 - Respuesta escrita · 13 pts
...
¿Para qué sirve la matriz de criterios con la que el equipo eligió entre sus dos alternativas?
...
## Pregunta 5 - Respuesta escrita · 14 pts
...
Marque **todas** las afirmaciones correctas sobre fuentes y antecedentes, según la sesión 9.
...
## Pregunta 7 - Respuesta escrita · 12 pts
...
## Pregunta 8 - Seleccion unica · 8 pts
...
El equipo quiere saber si una persona ajena entiende el flujo y sabe qué hacer en cada pantalla. ¿Con qué nivel de fidelidad conviene probar, y por qué?
...
Marque **todas** las afirmaciones correctas sobre lo que se califica de un prototipo en este curso.
