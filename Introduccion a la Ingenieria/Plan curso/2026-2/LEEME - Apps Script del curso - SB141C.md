# Apps Script del curso - Introducción a la Ingeniería · SB141C - 2026-2
...
```
_privado/CrearEncuentros - Introducción a la Ingeniería - SB141C.gs
```

Ruta completa desde la raiz de `Cursos`:

```
Introduccion a la Ingenieria/Plan curso/2026-2/_privado/CrearEncuentros - Introducción a la Ingeniería - SB141C.gs
```
