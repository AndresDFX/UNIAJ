# Apps Script del curso - Introducción a la Ingeniería · SB141B - 2026-2
...
```
_privado/CrearEncuentros - Introducción a la Ingeniería - SB141B.gs
```

Ruta completa desde la raiz de `Cursos`:

```
Introduccion a la Ingenieria/Plan curso/2026-2/_privado/CrearEncuentros - Introducción a la Ingeniería - SB141B.gs
```
