# Apps Script del curso - Programación II - 2026-2
...
```
_privado/CrearEncuentros - Programación II.gs
```

Ruta completa desde la raiz de `Cursos`:

```
Programacion II/Plan curso/2026-2/_privado/CrearEncuentros - Programación II.gs
```

> **Por que no lo ves en GitHub:** el `.gs` incluye los correos de los 20
...
Crea **13 eventos** (uno por sesion) e invita a los **20 estudiantes**,
