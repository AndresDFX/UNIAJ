...
**Demo que usted debe poder repetir:** El docente escribe un bloque Javadoc, genera la documentacion HTML desde NetBeans y luego corre las pruebas mostrando la barra en rojo, corrige la regla y la muestra en verde.
