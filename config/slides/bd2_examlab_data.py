...
EXAMLAB = {1: {'preguntas': [{'enunciado': '## 1. DDL base de VetCare DB\n'
                                 ...
                                 '`VetCare DB`. En esta base ya existe una tabla `equipo_pi` donde '
                                 'se registran los equipos del curso.\n'
                                 '\n'
                                 '**Escribe el SQL (PostgreSQL) que:**\n'
                                 '\n'
                                 '1. Registre tu equipo en `equipo_pi` con el nombre de tu equipo '
                                 'y los nombres completos de los 2 o 3 integrantes.\n'
                    ...
                    'rubrica': 'Las 3 tablas se crean sin error con PK, las 2 FK, el DEFAULT de '
                               ...
                               'registra el equipo en equipo_pi.',
                    'setup_sql': '-- Base limpia para el arranque de VetCare DB.\n'
                                 '-- Solo se entrega la bitacora de equipos; el esquema lo '
                   ...
                   {'enunciado': '## 2. Modelo ER de VetCare DB en Mermaid\n'
                                 ...
                                 'entregable de la clase: exportalo tambien como PNG para la '
                                 'carpeta del equipo.',
                   ...
                   {'enunciado': '## 5. Alcance del Proyecto Integrador VetCare DB\n'
                                 '\n'
                                 'Redacta la ficha de alcance de tu equipo. Debe incluir, con '
                                 'estos titulos:\n'
                                 '\n'
                                 '1. **Equipo y proyecto**: nombre del equipo, integrantes y una '
                                 'frase que describa VetCare DB.\n'
                                 ...
                                 'manejara nomina).\n'
                                 '4. **Tres reglas de negocio propias** del equipo, distintas o '
 ...
 2: {'preguntas': [{'enunciado': '## 1. Crear los roles de VetCare y otorgar privilegios\n'
                                 '\n'
                                 '**Esta es una clase autonoma: lee con calma, todo lo que '
                                 'necesitas esta aqui.**\n'
                                 '\n'
     ...
     'titulo': 'Taller Clase 2 en ExamLab - Administracion de BD y roles de VetCare (clase '
               'autonoma)'},
 ...
 4: {'preguntas': [{'enunciado': '## 1. Funcion de tarifas fn_precio_consulta\n'
                   ...
                   {'correctas': [0, 2, 4, 5],
                    ...
                    'opciones': ['Si la regla depende solo de columnas de la propia fila, como '
                                 ...
                                 'valor anterior.',
                                 'Validar solo en la aplicacion es suficiente si el equipo se '
                                 'compromete a no tocar la base con SQL directo.',
 ...
 6: {'preguntas': [{'enunciado': '## 1. Reescribir la consulta de agenda del dia\n'
                                 ...
                                 'agenda del dia. Es la version **ANTES**, tal como la escribio el '
                                 'equipo:\n'
                                 '\n'
                                 '```sql\n'
                                 'SELECT *\n'
                   ...
                   {'enunciado': '## 5. Justificacion tecnica del antes/despues (media pagina)\n'
                                 ...
                                 '`06_opt_despues.sql` en la carpeta del equipo.',
                    'puntos': 20,
 ...
 7: {'preguntas': [{'enunciado': '## 1. Crear los indices de las tablas calientes y probar que se '
                   ...
                   {'correctas': [0, 2, 3, 5],
                    'enunciado': '## 4. Riesgos de sobre-indexar VetCare\n'
                                 '\n'
                                 'El equipo propone crear un indice sobre **cada** columna de '
                   ...
                   {'enunciado': '## 5. Tabla de justificacion consulta -> indice\n'
                                 ...
                                 '\n'
                                 '1. **Regla de sobre-indexacion** que adopta tu equipo (por '
 ...
 11: {'preguntas': [{'enunciado': '## 1. ER consolidado de VetCare DB (version del hito)\n'
                    ...
                    {'enunciado': '## 4. Checklist de avance del PI (firmada)\n'
                                  '\n'
                                  'Entrega el checklist del hito con el estado real de tu equipo. '
                                  ...
                                  '14. Scripts organizados y ejecutables en orden en la carpeta '
                                  'del equipo.\n'
                                  '\n'
                                  'Cierra con: **porcentaje de avance** que declara el equipo '
                                  '(cuenta los `SI` como 1, los `PARCIAL` como 0,5), **el item mas '
                                  'debil** y una frase de compromiso firmada con los nombres de '
                                  'los integrantes y la fecha.',
                     'puntos': 15,
                     'rubrica': 'Los 14 items tienen estado, evidencia nombrada (archivo u objeto '
                                ...
                                'firma con nombres y fecha. Se descuenta por items sin evidencia o '
                    ...
                    {'enunciado': '## 5. Lista de gaps con responsable y fecha\n'
                                  ...
                                  '- Cada gap debe tener **un** responsable con nombre, no "el '
                                  'equipo".\n'
 ...
 13: {'preguntas': [{'enunciado': '## 1. El caso: que paso, por que y que aprendemos\n'
                    ...
                    {'enunciado': '## 2. Mejora implementada 1: cerrar la inyeccion de SQL en '
                                  ...
                                  'equipo escribio en su momento para el buscador de mascotas:\n'
                                  '\n'
                                  '```sql\n'
                                  ...
                                  'la regla que adopta el equipo sobre SQL dinamico y parametros '
                                  'ligados.',
                     'puntos': 25,
                     'rubrica': 'Se demuestra el uso normal y el ataque, evidenciando con COUNT '
                                ...
                                'vulnerable y se enuncia la regla del equipo. Se descuenta si no '
                    ...
                    {'enunciado': '## 5. Tres mejoras priorizadas para VetCare\n'
                                  '\n'
                                  'Cierra el informe con el plan de mejoras que tu equipo adopta a '
 ...
 15: {'preguntas': [{'enunciado': '## 1. Script maestro de entrega: VetCare DB de cero, en una '
                                  'sola corrida\n'
                                  '\n'
                                  '**Clase autonoma y evaluacion final del PI (20 % del Corte 3). '
                                  'Lee el enunciado completo antes de escribir.**\n'
                                  '\n'
                                  'Esta base esta **vacia**: solo existe la tabla `entrega_final` '
                                  'donde se registra el paquete del equipo. Debes entregar aqui el '
                                  ...
                                  '\n'
                                  '**Bloque 0 - Registro.** Un `INSERT INTO entrega_final (equipo, '
                                  'integrantes, enlace_zip)` con los datos reales de tu equipo.\n'
                                  '\n'
                    ...
                    {'correctas': [0, 1, 3, 5],
                     'enunciado': '## 3. Checklist de empaquetado del ZIP final\n'
                                  '\n'
                                  'El equipo va a subir el paquete final al modulo de Proyectos de '
                     ...
                     'opciones': ['Los scripts deben ir numerados en su orden de ejecucion '
                                  ...
                                  'inconsistente.',
                                  'Conviene incluir credenciales de la base de datos del equipo en '
                    ...
                    {'enunciado': '## 4. Acta de entrega y reparto de la sustentacion\n'
                                  ...
                                  '\n'
                                  '1. **Identificacion**: nombre del equipo, integrantes con '
                                  'nombre completo, asignatura (Bases de Datos II, FI303215), '
                                  'periodo 2026-2 y fecha de entrega.\n'
                                  ...
                                  '4. **Reparto de la sustentacion (5 a 8 minutos)**: quien habla '
                                  'en cada bloque y cuantos minutos, sumando entre 5 y 8. Todos '
                                  'los integrantes deben hablar.\n'
                                  '5. **Declaracion de autoria y uso de herramientas**: que hizo '
                                  'cada integrante, y si usaron asistentes de IA o codigo de '
                                  'terceros, en que parte y como lo verificaron.\n'
                                  '6. **Estado final declarado**: `COMPLETO`, `COMPLETO CON '
                                  'OBSERVACIONES` o `INCOMPLETO`, con una justificacion de dos '
                                  'lineas y la firma de los integrantes.',
                     'puntos': 20,
                     'rubrica': 'Las 6 secciones estan completas. El inventario nombra archivos '
                                ...
                                'real del paquete y reconoce lo que quedo abierto. El reparto suma '
                                'entre 5 y 8 minutos e incluye a todos los integrantes. Hay '
                    ...
                    {'enunciado': '## 5. Autoevaluacion de cierre: que harias distinto\n'
                                  ...
                                  '6. **Nota que te pondrias** al trabajo del equipo, de 1 a 5, '
                                  'con una linea de justificacion.',
                     'puntos': 15,
      ...
      'titulo': 'Taller Clase 15 en ExamLab - Entrega final y cierre de VetCare DB (clase '
                'autonoma)'}}
