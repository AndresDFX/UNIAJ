...
PLANTILLA_TALLER = {
    ...
    3: [
        ...
        "",
        "B) BITACORA DEL CICLO   (pregunta 11)",
        "   Cinco filas, en ESTE orden, una por comando. En la segunda columna va el",
        "   FRAGMENTO CONCRETO que esperas leer (numero de capas, identificador corto,",
        "   el 200); en la tercera, el SINTOMA con el que sabrias que ese comando",
        "   fallo. «Sale bien» o «da error» no suman nada.",
        "",
        "   | Comando                          | Que espero ver        | Como se que salio mal |",
        "   |----------------------------------|-----------------------|-----------------------|",
        ...
        "",
        "C) UN CASO QUE FALLA, DESARROLLADO   (pregunta 11)",
        "   Elige UNO de los cinco comandos y desarrollalo sobre TU propio Dockerfile:",
        "",
        "   Comando elegido     : ______________________________________________________",
        "   Causa realista      : ______________________________________________________",
        "   Sintoma que veria   : ______________________________________________________",
        "   Con que lo diagnostico : ___________________________________________________",
        "   Como lo corrijo     : ______________________________________________________",
        "",
        "D) LA TRAMPA DEL PUERTO   (pregunta 11)",
        "   Si publicas mal el mapeo -p, el contenedor arranca igual y parece sano.",
        "",
        "   Que veria en docker ps : ____________________________________________________",
        "   Que responderia el endpoint de salud, y por que : ___________________________",
        "",
...
DEMO_ARQ = {
    ...
    3: ("Construir, correr y verificar el stub en Killercoda — los 5 comandos de la bitacora", [
        ...
        "Comando 2 — `docker images | grep cloudlite-api` y lea en voz alta el TAG y el SIZE: «esto es lo que tienen que escribir en la fila 2 como lo que ESPERAN ver; si en vez del tag aparece vacio, ese es el sintoma».",
