...
EXAMLAB = {1: {'pasos': ['Paso 1: conforme el equipo de 2 o 3 integrantes y registre en la ficha del PI el '
               'nombre del equipo mas un rol unico por integrante (responsable de diagramas, '
               'responsable de informe, responsable de laboratorio), verificando que ningun '
               'integrante tenga dos roles y que el nombre del equipo quede escrito igual en la '
               'ficha y en la pregunta 1 del taller de ExamLab.',
               'Paso 2: elija un dominio concreto entre AgendaU, BiblioLite, InventarioLab, '
               ...
               'Paso 3: liste exactamente 4 capacidades con la forma verbo mas objeto de negocio '
               '(reservar cita, publicar cupo, cancelar reserva, notificar recordatorio), 3 '
               'actores humanos con lo que espera cada uno y 3 elementos de fuera de alcance, '
               'verificando que ninguna capacidad nombre tecnologia (nada de usar PostgreSQL ni '
               'desplegar en Docker) y que las 4 capacidades se lean como frases del negocio; '
               'queda en la seccion 1 del informe y se pega tal cual en la pregunta 1 de ExamLab.',
               'Paso 4: escriba en la pregunta de tipo diagrama de ExamLab el C4 Context en '
               ...
               'completa.',
               'Paso 5: resuelva la tabla comparativa de 4 filas nube frente a on-premise, cierre '
     ...
     'preguntas': [{'enunciado': '## Ficha del PI CloudLite App\n'
                                 '\n'
                                 'Escriba la ficha de su equipo respetando **exactamente** esta '
                                 'estructura de 6 bloques rotulados:\n'
                                 '\n'
                                 '1. **EQUIPO**: nombre del equipo y los 2 o 3 integrantes, con un '
                                 'rol unico cada uno (diagramas / informe / laboratorio).\n'
                                 '2. **DOMINIO**: una linea. Elija uno concreto: AgendaU '
                                 ...
                                 '3. **PROBLEMA**: exactamente 3 frases, en este orden: (a) quien '
                                 ...
                                 '5. **CAPACIDADES**: exactamente 4 capacidades en formato verbo + '
                    ...
                    'puntos': 20,
                    'rubrica': '4 pts los 6 bloques rotulados y completos. 4 pts el problema con '
                               'las 3 frases exigidas y una cifra medible. 4 pts los 3 actores con '
                               'expectativa explicita. 5 pts las 4 capacidades en verbo + objeto '
                               'sin mencionar tecnologia. 3 pts las 3 exclusiones. Si el dominio '
                               'es generico (app de la universidad, red social), los bloques 2 y 3 '
                               'valen cero.',
                    'tipo': 'abierta'},
 ...
 2: {'pasos': ['Paso 1: relea la ficha y el C4 Context de la Clase 1 y copie en el encabezado del '
     ...
     'preguntas': [{'enunciado': '## Matriz IaaS / PaaS / SaaS aplicada a su dominio\n'
                   ...
                   {'enunciado': '## ADR-001: modelo de servicio dominante de CloudLite\n'
                                 ...
                                 'credito) y una de la capacidad real del equipo (2 o 3 personas, '
                                 'un semestre).\n'
 ...
 3: {'pasos': ['Paso 1: decidan cual de los contenedores de CloudLite se contenerizara hoy (la API '
               ...
               'Paso 4: abra Play with Docker (o Killercoda si no carga), ejecute docker build -t '
     ...
     'preguntas': [{'correctas': [0, 2, 3],
                   ...
                   {'enunciado': '## Dockerfile del stub de CloudLite\n'
                                 ...
                                 'ocurre en Play with Docker (pregunta 4). Aqui se evalua el '
                   ...
                   {'enunciado': '## Consola Linux: arme y valide el contexto de build\n'
                                 ...
                                 'Docker**: aqui **no** se ejecuta `docker build`, eso va en Play '
                                 'with Docker (pregunta 4). Lo que se evalua es que el **contexto '
                    ...
                    'rubrica': '6 pts los 5 archivos creados en /root/cloudlite-api con la '
                               ...
                               'consola.',
                    'tipo': 'so_consola'},
                   {'enunciado': '## Bitacora del laboratorio en Play with Docker\n'
                                 '\n'
                                 'Abra **Play with Docker** (si no carga, **Killercoda**), suba su '
                                 ...
                                 '- El **enlace de la sesion** del lab **mas la nota de '
                                 'caducidad** (`la sesion de PWD expira a las 4 horas`).\n'
     ...
     'resumen': 'El estudiante deja el contexto de build verificado en la consola de ExamLab, el '
                ...
                'en Play with Docker con su ruta de salud respondiendo 200.',
 ...
 6: {'pasos': ['Paso 1: liste 5 amenazas concretas de su dominio, una por cada categoria de '
     ...
     'preguntas': [{'enunciado': '## Modelo de amenazas STRIDE-lite de su dominio\n'
                   ...
                   {'enunciado': '## Politica de secretos de CloudLite\n'
                                 ...
                                 'el informe.\n'
                                 '3. **Quien accede**: quien de los 3 integrantes puede ver o '
                                 'rotar cada secreto y con que criterio de minimo privilegio.\n'
 ...
 8: {'pasos': ['Paso 1: creen o reutilicen el repositorio gratuito del equipo con el stub de la '
 ...
 10: {'pasos': ['Paso 1: liste los 6 elementos de costo de su diseno tomandolos del C4Deployment '
      ...
      'preguntas': [{'enunciado': '## Tabla de costos de CloudLite\n'
                    ...
                    {'enunciado': '## Tres acciones de sostenibilidad\n'
                                  ...
                                  '\n'
                                  '1. **Accion**: que hace el equipo, en imperativo (`apagar el '
 ...
 12: {'pasos': ['Paso 1: describan el escenario de carga del pico real de su dominio con los 6 '
                ...
                'pantalla, verificando que la suma de los minutos quede entre 5 y 8, que los 3 '
                'integrantes hablen y que cada seccion tenga una evidencia concreta que se pueda '
                'mostrar.',
      ...
      'preguntas': [{'enunciado': '## Escenario de carga del pico de su dominio\n'
                    ...
                    {'enunciado': '## Guion cronometrado del pitch\n'
                                  ...
                                  '- **Los integrantes del equipo deben aparecer todos** en la '
                                  'columna `Quien habla`; ninguno puede llevar mas de 3 filas.\n'
                     ...
                     'rubrica': '7 pts las 6 filas con las 6 secciones en orden y las 5 columnas. '
                                '4 pts que los minutos sumen entre 5 y 8 y que todos los '
                                'integrantes hablen. 4 pts que cada fila cite un artefacto '
 ...
 15: {'pasos': ['Paso 1: armen el paquete final y llenen el indice de 8 filas con entregable, '
                ...
                'docente y registren la tabla de tiempos reales por seccion con el integrante que '
                'hablo, verificando que el tiempo total quede entre 5 y 8 minutos y que el enlace '
      ...
      'preguntas': [{'enunciado': '## Indice del paquete final\n'
                    ...
                    {'enunciado': '## Reflexion: el trade-off mas dificil\n'
                                  ...
                                  '2. **La alternativa que descarto**: que era y quien del equipo '
                                  'la defendia.\n'
                    ...
                    {'enunciado': '## Evidencia del pitch y tiempos reales\n'
                                  ...
                                  'encabezados exactos:\n'
                                  '\n'
                                  '`Seccion | Tiempo real | Integrante que hablo | Evidencia '
                                  'mostrada`\n'
                                  '\n'
                                  ...
                                  '\n'
                                  '**Parte C.** Una linea de autoevaluacion del equipo: nota de 1 '
                                  'a 5 al trabajo del equipo y **el hecho concreto** que la '
                                  'sustenta.',
                     'puntos': 15,
                     'rubrica': '5 pts el enlace o la fecha del pitch con la verificacion de '
                                'acceso. 6 pts la tabla de 6 secciones con tiempo real integrante '
