...
CLASES = [
    {
        ...
        "hito_pi": "Equipo conformado y dominio del proyecto acotado",
        ...
        "taller": [
            "Formen equipo de 2-3 personas y definan quien sera el vocero tecnico del grupo ante el docente.",
        ...
        "pistas": [
            ...
            "¿Un compañero de otro equipo entenderia nuestro sistema en 30 segundos, sin que se lo expliquemos?",
            "¿Escribimos que NO hara el sistema, o dejamos la puerta abierta a que crezca sin control?"
        ],
        "solucion_pasos": [
            "Paso 1 resuelto. Equipos de 2-3: mas de tres personas hace que alguien quede sin trabajo real y se note en la sustentacion, donde se pregunta al azar. El vocero tecnico no es el que mas sabe, es el que centraliza la comunicacion con el docente.",
    ...
    },
    {
        ...
        "taller": [
            ...
            "Redacte la Definicion de Terminado del equipo para artefactos de diseño (por ejemplo: tiene diagrama en draw.io, tiene mockup, esta revisado por un compañero y tiene el visto bueno del cliente) y escribala en la cabecera del tablero.",
    ...
    },
    {
        ...
        "taller": [
            ...
            "Intercambiar el paquete completo con otro equipo y aplicar la rubrica de auditoria de seis puntos durante veinte minutos cronometrados, registrando cada hallazgo con ubicacion exacta, descripcion y severidad bloqueante, mayor o menor; queda prohibido proponer soluciones durante la revision.",
        ...
        "escenario": [
            "Cada equipo tiene tres artefactos de VetCare escritos en semanas distintas: el catalogo de RF y RNF, el diagrama con las especificaciones de casos de uso y el diagrama de clases con sus multiplicidades.",
        ...
        "pistas": [
            ...
            "Cuantos nombres distintos esta usando su equipo para referirse a la misma persona que lleva la mascota a la clinica?",
            "Si su equipo desapareciera y solo quedara el paquete escrito, alguien podria construir VetCare sin hacer una sola pregunta?"
        ],
        "solucion_pasos": [
    ...
    },
    {
        ...
        "taller": [
            ...
            "Paso 5. Hagan prueba de pasillo con un integrante de otro equipo, denle la tarea registrar la mascota Luna de la señora Perez y encontrar su ficha, no le expliquen nada, cronometren, cuenten clics y anoten los dos puntos donde dudo; escriban abajo los dos cambios concretos que haran al diseño por lo observado."
        ],
        "contexto": [
    ...
    },
    {
        ...
        "entregable": "Un documento en Google Docs con el guion minuto a minuto, el reparto nominal por integrante, la tabla de tres decisiones de diseño defendidas y el banco de diez preguntas con su respuesta, mas el indice del documento final consolidado, subido a ExamLab.",
        ...
        "taller": [
            ...
            "Paso 4. Hagan un ensayo cronometrado de pie, con el prototipo abierto, y registren el tiempo real de cada bloque; recorten lo que se paso y anoten los dos puntos donde el equipo se enredo al hablar.",
        ...
        "criterios": [
            "El guion tiene las cinco secciones en el orden problema, requisitos, modelo, interfaz y decisiones, con minutos asignados que suman doce y con todos los integrantes hablando al menos dos minutos.",
        ...
        "quiz": [
            ...
            {
                "tipo": "vf",
                "q": "En la sustentacion todos los integrantes deben hablar y cualquiera puede recibir preguntas sobre partes que no expuso.",
                "clave": "V"
            },
            {
                "tipo": "om",
