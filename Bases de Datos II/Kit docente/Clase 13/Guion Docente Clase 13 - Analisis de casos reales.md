...
### Clase autonoma: este texto es fundamento y guia a la vez - diapositiva 4
...
### Causa proxima y causa raiz: la distincion que separa el analisis de la anecdota - diapositiva 4
...
### Caso uno: el respaldo que nunca se restauro (GitLab, 2017) - diapositiva 5
...
### Caso dos: permisos excesivos (Capital One, 2019) - diapositiva 5
...
### Caso tres: perdida de datos en una migracion (MySpace, 2019) - diapositiva 5
...
### Caso cuatro: concurrencia, el que no llega a los titulares - diapositiva 5
...
### Lo que decide la calificacion: lecciones accionables - diapositiva 12
