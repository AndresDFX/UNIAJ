Capturas de la Clase 11 — Bases de Datos II
==============================================
...
1) cap01_demo.png — salida de la demo del docente
   - Abrir Live SQL / DB Fiddle + draw.io + ExamLab y repetir la demo: Recorrido de checklist + ejemplo demo de 3 min.
...
Despues de agregar una imagen, regenerar el guion:
   SOLO_CLASES=11 python config/slides/build_uniajc_bd2_all.py
