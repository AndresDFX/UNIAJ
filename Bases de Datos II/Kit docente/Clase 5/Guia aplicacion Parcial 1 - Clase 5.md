# Guia docente · Clase 5 · Parcial 1 (solo evaluacion)

> Dia de **parcial = solo evaluacion**. No hay tema nuevo ni avance de PI en clase.
> Bloque **120 min** · **virtual sincrona por Google Meet**.
> Enunciado: `Parciales/Parcial 1 - Administracion procedimientos y seguridad.docx` · la solucion es el mismo nombre con
...
- Clase 1 · 24/08 · Revisión de Bases de Datos I (VetCare)
- Clase 2 · 31/08 · Administración de bases de datos
- Clase 3 · 07/09 · Procedimientos almacenados
- Clase 4 · 14/09 · Funciones y disparadores · Seguridad y respaldo
...
Total **100 puntos** · nota = puntos / 20 sobre 5.0 · peso **10% del Corte 1 (30%)** ·
fecha **21/09/2026** · tiempo de resolucion previsto **90–100 minutos**.

## Antes de abrir la sesion (10 min)

1. Abre `Parciales/Parcial 1 - Administracion procedimientos y seguridad.docx` y **decide el canal de entrega**. El enunciado
...
3. Revisa que el enunciado no pregunte nada fuera de las Clases 1, 2, 3 y 4. Si algo se cuela
...
- No se responde, en este parcial: «¿la diferencia entre funcion y procedimiento es que la funcion retorna valor?» · «¿GRANT y REVOKE tienen que ver con el control de acceso?» · «¿esta opcion es la correcta?».
...
- **Responder la duda de contenido porque parece inofensiva.** «¿la diferencia entre funcion y procedimiento es que la funcion retorna valor?» es
...
**¿Entra lo de la Clase 4?** Si, y es lo mas reciente que entra. La portada del
...
**¿Cuanto vale cada seccion?** Esta en la portada: A. Selección múltiple — 20 pts · B. Verdadero / Falso — 20 pts · C. SQL / objetos programables — 25 pts · D. Caso seguridad y respaldo — 35 pts.
...
- Hoy no se avanza en el PI: se retoma en la **Clase 6**. La preparacion de la presentacion es la **Clase 12** y la sustentacion la **Clase 15**.
