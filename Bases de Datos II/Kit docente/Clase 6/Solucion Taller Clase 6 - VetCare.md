...
5. Guardar ambas versiones como 06_opt_antes.sql y 06_opt_despues.sql en tu carpeta del PI, y si el playground lo permite, adjuntar el resultado de EXPLAIN de cada una como evidencia de la mejora.
