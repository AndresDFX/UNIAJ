...
**[Slide 5] El cliente: la clinica Huellitas (1/2)** — 5 vinetas.
...
**[Slide 6] El cliente: la clinica Huellitas (2/2)** — 8 vinetas.

**[Slide 7] Por que esto no es Bases de Datos I, y el vocabulario minimo** — 7 vinetas.
...
**[Slide 8] Nivel conceptual y nivel fisico: dos vistas del mismo modelo** — 4 vinetas.
...
**[Slide 9] Clave primaria: natural o sustituta (1/2)** — 7 vinetas.

**[Slide 10] Clave primaria: natural o sustituta (2/2)** — 3 vinetas.

**[Slide 11] Normalizacion 1FN-3FN: primero la enfermedad (1/2)** — 8 vinetas.

**[Slide 12] Normalizacion 1FN-3FN: primero la enfermedad (2/2)** — 5 vinetas.

**[Slide 13] Clave foranea, borrado y por que la FK no basta (1/2)** — 6 vinetas.

**[Slide 14] Clave foranea, borrado y por que la FK no basta (2/2)** — 4 vinetas.

**[Slide 15] Baja logica: activa CHAR(1) en vez de DELETE** — 6 vinetas.
...
**[Slide 16] Que separa un diagrama ER de un dibujo (1/2)** — 5 vinetas.

**[Slide 17] Que separa un diagrama ER de un dibujo (2/2)** — 4 vinetas.

**[Slide 18] Tipos de datos: donde se pagan las facturas mas caras (1/2)** — 4 vinetas.

**[Slide 19] Tipos de datos: donde se pagan las facturas mas caras (2/2)** — 3 vinetas.

**[Slide 20] Convenciones de nombres para que el DDL corra a la primera** — 7 vinetas.
...
**[Slide 21] Herramientas del dia y que se puede demostrar con cada una** — 5 vinetas.
...
**[Slide 22] Del ER dibujado al codigo Mermaid que se entrega** — 4 vinetas.
...
**[Slide 23] Preguntas frecuentes del grupo (1/2)** — 4 vinetas.
  - Tres preguntas aparecen casi siempre y conviene tener la respuesta lista.

**[Slide 24] Preguntas frecuentes del grupo (2/2)** — 4 vinetas.
...
7. Por que esto no es Bases de Datos I, y el vocabulario minimo
8. Nivel conceptual y nivel fisico: dos vistas del mismo modelo
9. Clave primaria: natural o sustituta (1/2)
10. Clave primaria: natural o sustituta (2/2)
...
15. Baja logica: activa CHAR(1) en vez de DELETE
16. Que separa un diagrama ER de un dibujo (1/2)
17. Que separa un diagrama ER de un dibujo (2/2)
18. Tipos de datos: donde se pagan las facturas mas caras (1/2)
19. Tipos de datos: donde se pagan las facturas mas caras (2/2)
...
22. Del ER dibujado al codigo Mermaid que se entrega
23. Preguntas frecuentes del grupo (1/2)
24. Preguntas frecuentes del grupo (2/2)
25. ER minimo VetCare (con cardinalidad)
26. El DDL minimo que sostiene el ER
27. Demo del dia
28. Herramientas de hoy
29. Del boceto a ExamLab (diagrama)
30. Taller PI VetCare — contexto / por que importa
31. Taller PI VetCare — objetivo y criterios
32. Taller PI VetCare — escenario / datos de partida
33. Taller PI VetCare — pasos guiados
34. Taller PI VetCare — pistas (checklist vacio)
35. Criterios de exito / entregable
36. Para el PI esta semana
37. Cierre · Clase 1
...
### 35-55 · Demo paso a paso · [Slide 27][Slide 29]
...
**Cierre la demo dentro de ExamLab** [Slide 29] — es la parte que el estudiante no adivina: pase el boceto a codigo Mermaid con ayuda de una IA, peguelo en la pregunta de diagrama y muestrelo renderizado.
...
### 55-105 · Taller guiado = tarea del PI · [Slide 33]
...
### 105-115 · Criterios de exito + quiz corto · [Slide 35]
Repasar checklist del dia con [Slide 35] «Criterios de exito / entregable».
...
Proyectar [Slide 37] slide de cierre. Dudas finales.
