...
### Por que esto no es Bases de Datos I, y el vocabulario minimo - diapositiva 4
...
### Normalizacion 1FN-3FN: primero la enfermedad - diapositiva 4
...
### Clave foranea, borrado y por que la FK no basta - diapositiva 5
...
### Baja logica: activa CHAR(1) en vez de DELETE - diapositiva 5
...
### Que separa un diagrama ER de un dibujo - diapositiva 5
...
### Tipos de datos: donde se pagan las facturas mas caras - diapositiva 6
...
### Convenciones de nombres para que el DDL corra a la primera - diapositiva 6
...
### Herramientas del dia y que se puede demostrar con cada una - diapositiva 8
...
4. Teoria Core (breve)
5. ER minimo VetCare (con cardinalidad)
6. El DDL minimo que sostiene el ER
7. Demo del dia
8. Herramientas de hoy
9. Del boceto a ExamLab (diagrama)
10. Taller PI VetCare — contexto / por que importa
11. Taller PI VetCare — objetivo y criterios
12. Taller PI VetCare — escenario / datos de partida
13. Taller PI VetCare — pasos guiados
14. Taller PI VetCare — pistas (checklist vacio)
15. Criterios de exito / entregable
16. Para el PI esta semana
17. Cierre · Clase 1
...
### 35-55 · Demo paso a paso · [Slide 7][Slide 9]
...
**Cierre la demo dentro de ExamLab** [Slide 9] — es la parte que el estudiante no adivina: pase el boceto a codigo Mermaid con ayuda de una IA, peguelo en la pregunta de diagrama y muestrelo renderizado.
...
### 55-105 · Taller guiado = tarea del PI · [Slide 13]
...
### 105-115 · Criterios de exito + quiz corto · [Slide 15]
Repasar checklist del dia con [Slide 15] «Criterios de exito / entregable».
...
Proyectar [Slide 17] slide de cierre. Dudas finales.
