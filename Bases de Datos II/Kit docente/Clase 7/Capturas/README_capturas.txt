...
1) cap01_demo.png — salida de la demo del docente
   - Abrir ExamLab (PostgreSQL/PGlite) y repetir la demo: EXPLAIN ANALYZE con Seq Scan, CREATE INDEX idx_cita_fecha_hora, ANALYZE, y el mismo EXPLAIN mostrando Index Scan.
