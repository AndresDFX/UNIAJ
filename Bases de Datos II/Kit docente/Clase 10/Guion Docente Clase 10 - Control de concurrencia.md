...
### La transaccion como unidad de todo o nada - diapositiva 4
...
### Serializar de verdad existe, y cuesta - diapositiva 4
...
### Los tres fenomenos indeseables, en escenas de la clinica - diapositiva 5
...
### Los cuatro niveles de aislamiento se definen por lo que permiten - diapositiva 5
...
### Control pesimista: SELECT ... FOR UPDATE - diapositiva 7
...
### Control optimista: verificar unicamente al escribir - diapositiva 7
...
### Deadlock: la escena de VetCare y como se evita - diapositiva 7
...
### Antes de los niveles: la restriccion que cuesta una linea - diapositiva 6
